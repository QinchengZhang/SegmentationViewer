/*! MIT Licensed */ !(function (t) {
  ...
  var e = t.document,
    ...
    i = function (e, r) {
      (r = r || "log"),
        t.console && console[r] && console[r]("layui error hint: " + e);
    },
  ...
  (n.prototype.cache = r),
    ...
    (n.prototype.use = function (n, o, c, s) {
      function p(t, e) {
        ...
        ("load" === t.type ||
          ...
          v.removeChild(b),
          (function o() {
            return ++m > (1e3 * r.timeout) / 4
              ? i(h + " is not a valid module", "error")
              : void (r.status[h] ? f() : setTimeout(o, 4));
          })());
      }
      function f() {
        c.push(layui[h]),
          n.length > 1
            ? y.use(n.slice(1), o, c, s)
            : "function" == typeof o &&
              (function () {
                return layui.jquery &&
      ...
      if (
        ...
        0 === n.length || (layui["layui.all"] && l[h]))
      )
        return f(), y;
      var g =
        (l[h]
      ...
      if (
        ((g = g.replace(/^\{\/\}/, "")),
        !r.modules[h] && layui[h] && (r.modules[h] = g),
        r.modules[h])
      )
        !(function S() {
          return ++m > (1e3 * r.timeout) / 4
            ? i(h + " is not a valid module", "error")
            : void ("string" == typeof r.modules[h] && r.status[h]
                ? f()
                : setTimeout(S, 4));
        })();
      else {
    ...
    (n.prototype.link = function (t, n, o) {
      ...
      return (
        (l.rel = "stylesheet"),
        (l.href = t + (r.debug ? "?v=" + new Date().getTime() : "")),
        (l.media = "all"),
    ...
    (n.prototype.factory = function (t) {
      if (layui[t])
        return "function" == typeof r.callback[t] ? r.callback[t] : null;
    }),
    ...
    (n.prototype.extend = function (t) {
      ...
      for (var r in t)
        e[r] || e.modules[r]
          ? i(r + " Module already exists", "error")
          : (e.modules[r] = t[r]);
      return e;
    }),
    ...
    (n.prototype.data = function (e, r, n) {
      if (
        ((e = e || "layui"), (n = n || localStorage), t.JSON && t.JSON.parse)
      ) {
        ...
        return (
          "value" in r && (o[r.key] = r.value),
          r.remove && delete o[r.key],
    ...
    (n.prototype.each = function (t, e) {
      ...
      else for (r in t) if (o(r, t)) break;
      return n;
    }),
    ...
    (n.prototype.event = n.event =
      function (t, e, n, o) {
        ...
        return n === c
          ...
          : o
          ? ((r.event[l] = r.event[l] || {}), (r.event[l][s] = [o]), this)
          : (layui.each(r.event[l], function (t, e) {
              return "{*}" === s
                ? void layui.each(e, p)
                : ("" === t && layui.each(e, p),
    ...
    (r.position = function (e, o, i) {
      if (o) {
        ...
        if (
          ...
          (o.style.left = h + ("fixed" === y ? 0 : s(1)) + "px"),
          (o.style.top = p + ("fixed" === y ? 0 : s()) + "px"),
          !r.hasScrollbar())
        ) {
  ...
  (r.formatArr = function (e) {
    ...
    (D.prototype.preview = function () {
      ...
      if (t.isPreview) {
        ...
        a.html(n).css({ color: "#5FB878", "font-size": "14px;" }),
          setTimeout(function () {
  ...
  (I.prototype.config = {
        ...
        b = function () {
          ...
          return !r && d.sortKey
            ...
            : (layui.each(y, function (a, l) {
              ...
              d.layMain.find("." + p).remove(),
              d.layMain.find("tbody").html(v.join("")),
    ...
    (I.prototype.sort = function (e, i, a, l) {
      ...
      try {
        ...
        d.layHeader.find("th").find(S).removeAttr("lay-sort"),
      ...
      (d.sortKey = { field: n, sort: i }),
        u.autoSort &&
          ("asc" === i
            ...
            : "desc" === i
            ? (r = layui.sort(f, n, !0))
            : ((r = layui.sort(f, c.config.indexName)), delete d.sortKey)),
    ...
    (I.prototype.scrollPatch = function () {
      ...
      var r = e.layMain.height(),
        c = r - l;
      e.layFixed.find(k).css("height", i.height() >= c ? c : "auto"),
              ...
              e.preventDefault(),
                ...
                i.getCssRule(n, function (e) {
                  ...
                  (d.rule = e),
                    ...
                    (d.minWidth = l.data("minwidth") || a.cellMinWidth);
                });
            }
          }),
        F.on("mousemove", function (t) {
          if (d.resizeStart) {
            if ((t.preventDefault(), d.rule)) {
              ...
              a < d.minWidth && (a = d.minWidth),
                (d.rule.style.width = a + "px"),
                l.close(i.tipsIndex);
            }
            e = 1;
          }
        }).on("mouseup", function (t) {
          d.resizeStart && ((d = {}), o.css("cursor", ""), i.scrollPatch()),
            2 === e && (e = null);
        }),
        s
          .on("click", function (a) {
      ...
      return (
        layui.each(l, function (e, l) {
          return l.constructor === Array
            ? void i++
            : void (l[c.config.checkName] && (t++, a.push(c.clearCacheKey(l))));
        }),
