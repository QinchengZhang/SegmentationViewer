...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.miou = QtWidgets.QLabel(self.tab)
        self.miou.setGeometry(QtCore.QRect(740, 350, 54, 12))
        self.miou.setObjectName("Mean IOU")
        self.kappa = QtWidgets.QLabel(self.tab)
        self.kappa.setGeometry(QtCore.QRect(740, 380, 54, 12))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_5.setText(_translate("MainWindow", "Mean IOU"))
        self.label_6.setText(_translate("MainWindow", "Kappa"))
        self.accuracy.setText(_translate("MainWindow", "None"))
        self.miou.setText(_translate("MainWindow", "None"))
        self.kappa.setText(_translate("MainWindow", "None"))
